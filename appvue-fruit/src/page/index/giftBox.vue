<template>
	<div class="giftBox bg-f4f4f4">
		...
		<div class="proList" v-if="list.length > 0">
            <div class="list-item pd30 bg-fff flex bd-bt-f4f4f4 relative" v-for="(item,index) in list">
            	<router-link class="itemLinks flex flex-jc" :to="{name:'proDetails',params:{id:item.id}}">
